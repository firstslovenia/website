...
import styles from "./start-a-team.module.css";
      ...
      <main>
        <div className={`container ${indexStyles.mainContainer}`}>
          <div>
            <h1>
              {translate({
                id: "mentor.needed-hardware.title",
          ...
          <div>
            <h1>
              {translate({
                id: "mentor.more-info.title",
                message: "Where can we get more information?",
              })}
            </h1>
            <p>
              {translate({
                id: "mentor.more-info.rules",
                message: "Game manual (including rules) are available on ",
              })}
              <a href="https://ftc-resources.firstinspires.org/file/ftc/game/manual">
                {translate({ id: "this-link", message: "this link" })}
              </a>
              {translate({
                id: "mentor.more-info.registration",
                message: ", information on team registration are available on ",
              })}
          ...
          <div>
            <h1>
              {translate({
                id: "mentor.cost.title",
                message: "What are costs associated with starting a team?",
              })}
            </h1>
            <p>
              {translate({
                id: "mentor.cost.calculator",
                message: "Our costs calculator is available at",
              })}
            </p>
            <div className={styles.calculatorLinkContainer}>
