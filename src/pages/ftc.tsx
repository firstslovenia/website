    ...
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          {translate({
            id: "ftc.tagline",
            message: "🐤 chirping from the boot",
          })}
        </p>
      </div>
    </header>
          ...
          <div className={`container ${styles.mainContainer}`}>
            <p
              dangerouslySetInnerHTML={{
                __html: translate({
                  id: "ftc.what-we-do",
                  message: `Series of regional qualifiers and world championship, 𝐹𝐼𝑅𝑆𝑇 Tech Challenge,
                            ...
                            website and watch season announcement video.`,
                }),
              }}
            ></p>
            ...
            <center>
              <iframe
                width="560"
                height="315"
                src="https://www.youtube.com/embed/XLp3fYreLLk"
