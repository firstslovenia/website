    ...
    return (
        <header className={clsx('hero hero--primary', styles.heroBanner)}>
            <div className="container">
                ...
                <p className="hero__subtitle">{translate({id: 'fgc.tagline', message: "Representing chicken shaped country on the global stage"})}</p>
            </div>
        </header>
    );
}
            ...
            <main>
                <section>
                    <div className="container" style={{paddingTop: "20px"}}>
                        <p dangerouslySetInnerHTML={{__html: translate({id: "fgc.what-we-do", message: `
